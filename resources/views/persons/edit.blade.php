                    ...
                    <div class="col-md-12">
                        <div class="panel panel-white">
                            <div class="panel-body">
                                <form method="POST" action="{{ route('person.update', $data->id) }}" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="file" class="form-control inputImg" name="avatars" value="" data-id="imgPreview">
