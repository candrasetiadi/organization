                            ...
                            <div class="panel-body">
                                <form method="POST" action="{{ route('organization.store') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="url" placeholder="https://example.com" class="form-control" name="website" value="{{ old('website') }}" maxlength="200" required>
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label for="logos">Logo</label>
                                        <input type="file" class="form-control inputImg" name="logos" value="{{ old('logos') }}" data-id="imgPreview" required>
